...
[^tbl1]: Functions from `LightLogR` are presented as links to the function documentation. General analysis functions (from package `dplyr`) are presented as normal text.
