...
The dataset we will be using comes from a data collection during COVID-19 (November 2020). More information on the context of data collection are to be found in [@bhandari2022]
